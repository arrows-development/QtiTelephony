...
# direct methods
.method public static synthetic $r8$lambda$Hism_IfWEjZzRs4qApro9RB_ZDM(ILandroid/telephony/SubscriptionInfo;)Z
    .locals 0

    .line 0
    invoke-static {p0, p1}, Lcom/qti/phone/QtiNtnProfileHelper;->lambda$getEsimProfileIccIds$0(ILandroid/telephony/SubscriptionInfo;)Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/qti/phone/QtiRadioProxy;)V
    ...
    invoke-direct {p1, p0}, Lcom/qti/phone/QtiNtnProfileHelper$QtiNtnProfileCallback;-><init>(Lcom/qti/phone/QtiNtnProfileHelper;)V
...
.method private getCardId(I)I
    ...
    :cond_5
    :goto_1
    const-string p0, "Card info not available"
...
.method private getEsimProfileIccIds(II)Ljava/util/List;
    .locals 0
    ...
    .line 93
    iget-object p0, p0, Lcom/qti/phone/QtiNtnProfileHelper;->mSubMgr:Landroid/telephony/SubscriptionManager;
    ...
    new-instance p1, Lcom/qti/phone/QtiNtnProfileHelper$$ExternalSyntheticLambda0;

    invoke-direct {p1, p2}, Lcom/qti/phone/QtiNtnProfileHelper$$ExternalSyntheticLambda0;-><init>(I)V
...
.method private handleGetAllEsimProfiles(II)V
    ...
    .line 226
    iget v0, p0, Lcom/qti/phone/QtiNtnProfileHelper;->mRetryCounter:I
    ...
    .line 227
    iget-object v0, p0, Lcom/qti/phone/QtiNtnProfileHelper;->mHandler:Landroid/os/Handler;
    ...
    .line 229
    iget p1, p0, Lcom/qti/phone/QtiNtnProfileHelper;->mRetryCounter:I

    add-int/2addr p1, v2

    iput p1, p0, Lcom/qti/phone/QtiNtnProfileHelper;->mRetryCounter:I
    ...
    .line 233
    iput v1, p0, Lcom/qti/phone/QtiNtnProfileHelper;->mRetryCounter:I

    .line 234
    invoke-direct {p0, p1, v0}, Lcom/qti/phone/QtiNtnProfileHelper;->getEsimProfileIccIds(II)Ljava/util/List;
    ...
    const-string v4, "handleGetAllEsimProfiles: "
    ...
    const-string v4, "QtiNtnProfileHelper"
    ...
    .line 239
    :try_start_0
    invoke-virtual {p0, p1, v2, p2, v0}, Lcom/qti/phone/QtiRadioProxy;->sendAllEsimProfiles(IZILjava/util/List;)Lcom/qti/extphone/Token;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private static synthetic lambda$getEsimProfileIccIds$0(ILandroid/telephony/SubscriptionInfo;)Z
    .locals 0
